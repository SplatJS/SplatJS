...
/**
 * Callback for when a timer is ticked
 * @callback tickCallback
 * @param {number} elapsedMillis The number of milliseconds that have elapsed.
 */
 ...
 * @constructor
 * @param {tickCallback} onTick Called when the Timer is {@link Timer#tick tick()}ed
 * @param {number} expireMillis The number of milliseconds until the Timer expires
 * @param {expireCallback} onExpire Called when the Timer expires
 */
