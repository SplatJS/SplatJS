 ...
 * @param {emptyCallback} initFunc A callback to be called every time the Scene is {@link Scene#start start()}ed.
 * @param {simulationCallback} simulationFunc A callback the updates the state of the game's simulation.
