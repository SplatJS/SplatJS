...
/**
 * A {@link Camera} that tracks an {@link Entity} to keep it onscreen within an invisible box. If the entity moves outside of the invisible box, the camera is adjusted the minimal amount so that the entity is back inside the box.
 * @constructor
 * @param {Entity} entity The entity for the camera to track.
 * @param {number} width The width of the invisible box to keep the {@link Entity} within.
 * @param {number} height The height of the invisible box to keep the {@link Entity} within.
...
function EntityBoxCamera(entity, width, height, screenCenterX, screenCenterY) {
	/**
	 * The {@link Entity} for the camera to track.
	 * @member {Entity}
	 */
	this.entity = entity;
	/**
...
/**
 * Adjust the camera so that it keeps {@link EntityBoxCamera#entity} within the invisible box. This is usually automatically called by the {@link Scene} for you.
 */
